...
@CucumberOptions(
        features = "src/test/java/com/ejemplo/features/aceptacion", // Ruta a los archivos .feature
        glue = "com.ejemplo.tests.aceptacion", // Paquete donde están las Step Definitions
...
public class RunCucumberTestAceptacion {
}
